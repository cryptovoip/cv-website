...
export const metadata: Metadata = {
  ...
  description: "Connect every CCTV brand, protect your video. We provide technology that thinks securely.",
};
  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <Header />
        <main className="flex-grow pt-20 relative z-10 text-white">
          {children}
        </main>
        <Footer />
      </body>
